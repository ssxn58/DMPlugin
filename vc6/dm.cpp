...
long Idmsoft::RegEx(LPCTSTR code, LPCTSTR Ver, LPCTSTR ip)
{
	long result;
	static BYTE parms[] =
...
long Idmsoft::SetDisplayDelay(long t)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
...
long Idmsoft::DeleteIni(LPCTSTR section, LPCTSTR key, LPCTSTR file)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR VTS_BSTR VTS_BSTR;
...
long Idmsoft::DeleteIniPwd(LPCTSTR section, LPCTSTR key, LPCTSTR file, LPCTSTR pwd)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR VTS_BSTR VTS_BSTR VTS_BSTR;
...
long Idmsoft::EnableSpeedDx(long en)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
...
long Idmsoft::EnableIme(long en)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
...
long Idmsoft::Reg(LPCTSTR code, LPCTSTR Ver)
{
	long result;
	static BYTE parms[] =
		VTS_BSTR VTS_BSTR;
...
CString Idmsoft::SelectDirectory()
{
	CString result;
...
long Idmsoft::LockDisplay(long lock)
{
	long result;
	static BYTE parms[] =
		VTS_I4;
...
long Idmsoft::FoobarSetSave(long hwnd, LPCTSTR file, long en, LPCTSTR header)
{
	long result;
	static BYTE parms[] =
		VTS_I4 VTS_BSTR VTS_I4 VTS_BSTR;
